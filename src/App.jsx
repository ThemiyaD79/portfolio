...
// --- CUSTOM SVG ICONS FOR REAL BRANDS ---
...
const InteractiveCard = ({ children }) => {
  return (
    <div className="group relative rounded-[2rem] bg-white/40 backdrop-blur-xl border border-white/60 p-8 transition-all duration-500 ease-out hover:bg-white/60 hover:scale-[1.02] hover:shadow-[0_20px_40px_-15px_rgba(236,72,153,0.3)] hover:border-pink-300 cursor-pointer overflow-hidden z-10">
      <div className="absolute inset-0 bg-gradient-to-br from-pink-200/20 to-sky-200/20 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
...
export default function App() {
  ...
  const fullText = "Data Analytics Developer";
  ...
  return (
    <div className="relative min-h-screen font-sans selection:bg-pink-200 selection:text-pink-900 bg-slate-50 overflow-x-hidden">
      ...
      <div className="fixed inset-0 w-full h-full z-0 pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-pink-300/40 rounded-full mix-blend-multiply blur-[120px] animate-[pulse_8s_ease-in-out_infinite]"></div>
        <div className="absolute top-[20%] right-[-10%] w-[40vw] h-[40vw] bg-sky-300/50 rounded-full mix-blend-multiply blur-[120px] animate-[pulse_10s_ease-in-out_infinite_reverse]"></div>
        <div className="absolute bottom-[-20%] left-[20%] w-[60vw] h-[60vw] bg-indigo-200/40 rounded-full mix-blend-multiply blur-[120px] animate-[pulse_12s_ease-in-out_infinite]"></div>
      </div>

      {/* HEADER */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/30 backdrop-blur-2xl border-b border-white/40 px-6 py-4 shadow-sm">
        <div className="max-w-6xl mx-auto flex justify-between items-center relative z-10">
          ...
          <button 
            ...
            className="md:hidden p-2 rounded-xl bg-white/50 backdrop-blur-md text-slate-700 hover:bg-white/80 transition-all"
          >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-white/40 flex flex-col gap-4 text-center font-bold bg-white/40 backdrop-blur-xl rounded-b-2xl pb-4 shadow-xl">
      ...
      {/* HERO SECTION */}
      <section id="hero" className="pt-40 pb-20 px-6 max-w-6xl mx-auto flex flex-col items-start justify-center min-h-[85vh] relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/50 backdrop-blur-md text-xs font-bold text-slate-700 mb-8 border border-white/80 shadow-sm hover:scale-105 transition-transform cursor-default">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <a 
            href="#projects" 
            className="px-8 py-4 rounded-2xl bg-slate-900 hover:bg-pink-500 text-white font-bold shadow-xl hover:shadow-pink-500/30 transition-all duration-300 hover:-translate-y-1"
          >
            Explore Projects
          </a>
          ...
          <div className="flex items-center gap-4 ml-4">
            <a 
              href="https://github.com/ThemiyaD79" 
              target="_blank" 
              rel="noreferrer"
              className="p-4 rounded-2xl bg-white/40 backdrop-blur-md border border-white/60 text-slate-700 hover:bg-slate-900 hover:text-white hover:scale-110 hover:-translate-y-1 transition-all shadow-sm flex items-center justify-center"
            >
              <GithubIcon className="w-6 h-6" />
            </a>
            <a 
              href="https://www.linkedin.com/in/themiya-abeyrathna/" 
              target="_blank" 
              rel="noreferrer"
              className="p-4 rounded-2xl bg-white/40 backdrop-blur-md border border-white/60 text-slate-700 hover:bg-[#0A66C2] hover:text-white hover:scale-110 hover:-translate-y-1 transition-all shadow-sm flex items-center justify-center"
            >
      ...
      <section id="experience" className="py-24 px-6 max-w-6xl mx-auto relative z-10">
        ...
        <h2 className="text-4xl font-extrabold text-slate-900 mb-12">Professional Experience</h2>

        <div className="grid gap-8">
          <InteractiveCard>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                <h3 className="text-2xl font-extrabold text-slate-900">Information Technology Intern (Data Analytics)</h3>
                <p className="text-sky-600 font-bold text-lg mt-1">United Tobacco Processing SL (UTP SL)</p>
              </div>
              <span className="px-4 py-2 rounded-full text-sm font-bold bg-pink-100 text-pink-700 border border-pink-200 self-start md:self-auto shadow-sm">
                Present / Ongoing
              </span>
            </div>
          ...
          <InteractiveCard>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              <div>
                <h3 className="text-2xl font-extrabold text-slate-900">Freelance Full Stack Developer & Database Engineer</h3>
                <p className="text-sky-600 font-bold text-lg mt-1">StackNet (Pvt) Ltd</p>
              </div>
              <span className="text-sm font-bold text-slate-500 bg-white/60 px-4 py-2 rounded-full border border-white/80 self-start md:self-auto shadow-sm">
                Project-Based (2026)
              </span>
            </div>
            <ul className="list-disc list-inside text-slate-600 space-y-3 text-lg">
      ...
      <section id="projects" className="py-24 px-6 max-w-6xl mx-auto relative z-10">
        ...
        <h2 className="text-4xl font-extrabold text-slate-900 mb-12">GitHub Repositories & Solutions</h2>
          ...
          {projects.map((proj, idx) => (
            <InteractiveCard key={idx}>
              <div className="flex flex-col h-full justify-between">
                <div>
                  <span className="text-sm font-black uppercase tracking-wider text-pink-500 mb-3 block">{proj.category}</span>
                  <h3 className="text-2xl font-extrabold text-slate-900 mb-4">{proj.title}</h3>
                  <p className="text-slate-600 text-lg mb-8 leading-relaxed">{proj.description}</p>
                </div>

                <div>
                  <div className="flex flex-wrap gap-2 mb-8">
                    {proj.tech.map((t, i) => (
                      <span key={i} className="text-sm px-3 py-1.5 rounded-lg bg-white/60 text-slate-800 border border-white/80 font-bold shadow-sm">
                        {t}
                      </span>
                    ))}
                  </div>
      ...
      <section id="skills" className="py-24 px-6 max-w-6xl mx-auto relative z-10">
        ...
        <h2 className="text-4xl font-extrabold text-slate-900 mb-12">Skills & Competencies</h2>

        <div className="grid md:grid-cols-3 gap-8">
          {skills.map((group, idx) => (
            <InteractiveCard key={idx}>
              <h3 className="text-xl font-extrabold text-slate-900 mb-6 pb-4 border-b border-white/60">{group.category}</h3>
              <div className="flex flex-wrap gap-3">
                {group.items.map((item, i) => (
                  <span key={i} className="px-4 py-2 rounded-xl bg-white/60 text-sm font-bold text-slate-800 border border-white/80 shadow-sm hover:scale-110 hover:bg-pink-100 hover:text-pink-700 transition-all cursor-default">
                    {item}
                  </span>
                ))}
              </div>
      ...
      <section id="contact" className="py-24 px-6 max-w-6xl mx-auto relative z-10">
        <InteractiveCard>
          <div className="text-center py-6">
            <h2 className="text-4xl md:text-5xl font-extrabold text-slate-900 mb-6">Let's Work Together</h2>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <a 
                href="mailto:dgthemiya@gmail.com" 
                className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-sky-500 to-pink-500 hover:from-sky-400 hover:to-pink-400 text-white font-bold shadow-xl hover:shadow-pink-500/40 transition-all hover:-translate-y-1 hover:scale-105"
              >
                <Mail size={20} /> dgthemiya@gmail.com
              </a>
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="inline-flex items-center gap-3 px-8 py-4 rounded-2xl bg-white/60 backdrop-blur-md border border-white/80 text-slate-900 font-bold transition-all hover:bg-white/80 hover:text-[#0A66C2] hover:-translate-y-1 hover:scale-105 shadow-sm hover:shadow-lg"
              >
      ...
      {/* FOOTER */}
      <footer className="py-10 text-center text-sm font-bold text-slate-500 border-t border-slate-300/30 relative z-10 bg-slate-50/50 backdrop-blur-sm">
        <p>© {new Date().getFullYear()} D.G. Themiya Abeyrathna. Built with React & Tailwind CSS.</p>
      </footer>
